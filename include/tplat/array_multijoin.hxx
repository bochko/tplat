...
namespace tplat::t {
    ...
    struct array_multijoin<array_0, array_1, array_n...> {
        static constexpr auto value = tplat::array_join<tplat::array_join<array_0, array_1>, array_multijoin<array_n...>::value>;
    };
}

namespace tplat {
    template <auto... array_n>
    static constexpr auto array_multijoin = tplat::t::array_multijoin<array_n...>::value;
}
