...
static const auto parameters_eq = 
    std::vector<std::pair<std::string_view, std::string_view>>{
        {tplat::array_as_string_view<std::array<char, 0>{}>, std::string_view{""}},
        {tplat::array_as_string_view<std::array<char, 0>{}>, std::string_view{"\0"}},
        {tplat::array_as_string_view<std::array{'*'}>, std::string_view{"*"}},
        {tplat::array_as_string_view<std::array{':',')'}>, std::string_view{":)"}},
        {tplat::array_as_string_view<std::array{'-','-','>'}>, std::string_view{"-->"}},
        {tplat::array_as_string_view<std::array{'h','e','l','l','o',' ','w','o','r','l','d'}>, std::string_view{"hello world"}}
    };
...
INSTANTIATE_TEST_SUITE_P(tplat,
                         test_array_as_string_view_EQ,
                         testing::ValuesIn(parameters_eq));

INSTANTIATE_TEST_SUITE_P(tplat,
                         test_array_as_string_view_NE,
